...
func BuiltinDefinitions() []Definition {
	...
	defs := make([]Definition, 0, len(core)+48)
	...
	defs = append(defs,
		...
		Definition{Identity: builtinIdentity("ResourceDefinition", "connector-class"), APIVersion: "connections.datascape.dev/v1alpha1", Kind: "ConnectorClass", Plural: "connectorclasses", Scope: "Cluster", Category: "class", ProviderType: "datascape.dev/connector", Schema: objectSchema([]string{"interface", "transport"}, map[string]string{"interface": "string", "transport": "string", "driver": "string", "operations": "array", "compatibleEngines": "array", "providerInstanceRef": "string", "targetCompatibility": "array", "parameters": "object", "configuration": "object", "configMapping": "object"})},
		Definition{Identity: builtinIdentity("ResourceDefinition", "cdc-class"), APIVersion: "cdc.datascape.dev/v1alpha1", Kind: "CDCClass", Plural: "cdcclasses", Scope: "Cluster", Category: "class", ProviderType: "datascape.dev/cdc", Schema: objectSchema([]string{"engine", "providerInstanceRef"}, map[string]string{"engine": "string", "providerInstanceRef": "string", "supportedConnectorClasses": "array", "targetCompatibility": "array", "parameters": "object", "workerConfiguration": "object"})},
		Definition{Identity: builtinIdentity("ResourceDefinition", "cdc-instance"), APIVersion: "cdc.datascape.dev/v1alpha1", Kind: "CDCInstance", Plural: "cdcinstances", Scope: "Namespaced", Category: "component", ProviderType: "datascape.dev/cdc", Capabilities: []string{"datascape.dev/source.change-stream"}, BindingRoles: []string{"target"}, Schema: objectSchema([]string{"classRef"}, map[string]string{"classRef": "string", "ownership": "string", "providerInstanceRef": "string", "replicas": "integer", "resources": "object", "endpoint": "object", "credentialsRef": "string", "managementPolicy": "string", "parameters": "object", "workerConfiguration": "object", "verification": "object"})},
		...
		Definition{Identity: builtinIdentity("ResourceDefinition", "cdc-operation"), APIVersion: "operations.datascape.dev/v1alpha1", Kind: "CDCOperation", Plural: "cdcoperations", Scope: "Namespaced", Category: "operation", ProviderType: "datascape.dev/cdc", Schema: objectSchema([]string{"targetRef", "action", "idempotencyKey"}, map[string]string{"targetRef": "string", "action": "string", "idempotencyKey": "string", "providerInstanceRef": "string", "parameters": "object", "approval": "object", "timeout": "string", "retryPolicy": "object", "preconditions": "array", "verification": "object", "rollback": "object", "targetCompatibility": "array", "ownership": "string", "team": "string"})},
	)
	return defs
}
